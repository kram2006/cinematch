...
# --- SIGMA UI OVERRIDE ---
st.markdown('<div class="nav-container"><div class="brand">CINEMATCH // PRIMAL</div><div style="font-family:\'JetBrains Mono\'">SYS.VER.4.0.1</div></div>', unsafe_allow_html=True)
